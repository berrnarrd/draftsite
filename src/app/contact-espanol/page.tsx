...
const ContactPage: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        emailjs.send(
            ...
            router.push('/message-sent-espanol');
        }, (error) => {
    ...
    return (
        <div className="relative min-h-screen flex flex-col bg-[#006D5B] text-white">
            ...
            <main className="flex-grow flex flex-col items-center justify-center py-12 px-4 md:px-8 md:py-16">
                <h2 className="text-3xl md:text-5xl font-bold mb-8">Contáctenos</h2>
                <div className="w-full max-w-6xl flex flex-col lg:flex-row bg-white bg-opacity-20 p-6 rounded-lg">
                    <div className="w-full lg:w-1/2 p-4">
                        <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                            <div className="flex flex-col">
                                <label className="text-lg font-semibold mb-2">Nombre</label>
                            ...
                            <div className="flex flex-col">
                                <label className="text-lg font-semibold mb-2">Mensaje</label>
                            ...
                            <button type="submit" className="p-3 rounded bg-[#FFB81C] text-white font-semibold">Enviar Mensaje</button>
                        </form>
                    </div>
                    <div className="w-full lg:w-1/2 p-4">
                        <iframe
